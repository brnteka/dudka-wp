...
<html {{ language_attributes() }} class="no-js">
    <head>
        ...
        <link rel="stylesheet" href="{{ \Helpers\General::asset_hash('/dudka-wp/wp-content/themes/classy/dist/main.css') }}">
    </head>
    ...
    <body {{ body_class($body_additional) }}>
        ...
        <script src="{{ \Helpers\General::asset_hash('/dudka-wp/wp-content/themes/classy/dist/index.js') }}"></script>
